...
#include "utils.h"
#include "shaders/spirv/fs_basic_quad.sc.bin.h"
#include "shaders/spirv/vs_basic_quad.sc.bin.h"
...
void setup_buffers_and_shaders()
{
    ...
    shader_program = load_shader_embedded(vs_basic_quad_spv, sizeof(vs_basic_quad_spv), fs_basic_quad_spv, sizeof(fs_basic_quad_spv));

    // shader = load_shader_embedded(fs_basic_quad_glsl, sizeof(fs_basic_quad_glsl),
    //                               vs_basic_quad_glsl, sizeof(vs_basic_quad_glsl));
